 ...
 * @author Luan
 */
public class AdcEstoque2 extends javax.swing.JDialog {
        ...
        try{
            ...
            if(Produto.getText().equals("") || Quantidade.getText().equals("")){
                ...
                if(ss.checarLetras(Quantidade.getText())==false && (Integer.parseInt(Quantidade.getText())>0)){
                    ...
                    h.setMovimento(((Integer.parseInt(Quantidade.getText()))));
                    h.setData(data());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdcEstoque2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdcEstoque2().setVisible(true);
            }
        });
    }
